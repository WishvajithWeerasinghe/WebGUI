            ...
            <div v-if="menuOpen && !showLogin && !showSignup" class="menu-drawer">
                ...
                <div class="drawer-actions">
                    ...
                    <button class="drawer-action-btn" @click="toggleDark">
                        ...
                        <svg v-else viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" width="18"
                            height="18">
        ...
        <Transition name="scale-up">
            <div v-if="showLogin" class="auth-modal">
                ...
                <div class="modal-img-side">
                    <img src="@/assets/login.jpg" alt="Room" class="modal-img" />
                ...
                <div class="modal-form-side">
                    ...
                    <div class="auth-form">
                        ...
                        <div class="auth-field">
                            ...
                            <input v-model="login.password" type="password" placeholder="******" class="auth-input" />
                        </div>
                ...
                <div class="modal-form-side">
                    ...
                    <div class="auth-form">
                        <div class="auth-field">
                            ...
                            <input v-model="signup.username" type="text" placeholder="A.B.C Perera"
                                class="auth-input" />
                        </div>
                        <div class="auth-field">
                            <label class="auth-label">EMAIL</label>
                            <input v-model="signup.email" type="email" placeholder="perera@gmail.com"
                                class="auth-input" />
                        </div>
                        <div class="auth-field">
                            <label class="auth-label">PASSWORD</label>
                            <input v-model="signup.password" type="password" placeholder="******" class="auth-input" />
                        </div>
